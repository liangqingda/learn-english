...
- **分类记录**：把实际讲解过的内容保存为词汇、短语、语法、发音、用法和错误六类记录。
...
- **统一学习菜单**：所有英语讲解、纠错和复习回复都提供 3 至 5 个可直接用数字选择的后续活动，并始终包含场景对话和四六级规格习题。
...
- 支持复习错误与语法、词汇与短语、发音与用法，也支持基于学习记录生成场景对话和四六级规格习题。
